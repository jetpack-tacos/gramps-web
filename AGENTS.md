# Multi-Agent Git Safety Rules (Frontend Repo)

This frontend repo is edited by multiple AI agents across multiple IDEs.
...
3. Commit only files for the current frontend task.
